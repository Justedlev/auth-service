...
import com.justedlev.auth.constant.RoleGroupConstant;
...
public class RoleDataBoot implements ApplicationRunner {
    ...
    private static final Map<String, String> roleMap = Map.of(
            RoleTypeConstant.USER, RoleGroupConstant.USERS,
            RoleTypeConstant.SUPER_USER, RoleGroupConstant.USERS,
            RoleTypeConstant.ADMIN, RoleGroupConstant.ADMINISTRATORS,
            RoleTypeConstant.SUPER_ADMIN, RoleGroupConstant.ADMINISTRATORS
    );
