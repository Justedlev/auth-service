...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests()
                ...
                .antMatchers(SUPER_ADMIN_ACCESS).hasAnyRole(RoleTypeConstant.SUPER_ADMIN)
                .antMatchers(ADMIN_ACCESS).hasAnyRole(RoleTypeConstant.SUPER_ADMIN, RoleTypeConstant.ADMIN)
                .antMatchers(SUPER_USER_ACCESS).hasAnyRole(RoleTypeConstant.SUPER_ADMIN, RoleTypeConstant.ADMIN,
                        RoleTypeConstant.SUPER_USER)
                .antMatchers(USER_ACCESS).hasAnyRole(RoleTypeConstant.SUPER_ADMIN, RoleTypeConstant.ADMIN,
                        RoleTypeConstant.SUPER_USER, RoleTypeConstant.USER)
                .anyRequest()
                .authenticated();
